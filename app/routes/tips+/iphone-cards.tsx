	...
	return (
		<div className="p-12 font-poppins">
			<div className="relative aspect-[8/16] w-80 overflow-hidden rounded-3xl bg-white shadow-2xl shadow-cyan-500/40 ring-[16px] ring-black">
				...
				{/* Content overlay */}
				<div className="absolute inset-x-0 bottom-0 grid h-3/4 items-end bg-gradient-to-t from-rose-500 from-40% mix-blend-overlay">
					<div className="w-1/2 pb-10 pl-6">
						<div className="grid auto-rows-min items-end">
							<h2 className="text-6xl font-thin tracking-wide text-white">
								Kody McWheel
							</h2>
